...
#initialize data to pass to the graph/robot
class LidarData:
...
#calculate data by reading the byte
def CalcLidarData(str):
    str = str.replace(' ','')
    #Lidar detection speed (Unused)
